# write_main_window.py
# Run: python write_main_window.py
...
path = os.path.join("gui", "main_window.py")
...
if null_count == 0:
    print("File is clean — no null bytes")
else:
    print("ERROR: File still has null bytes")